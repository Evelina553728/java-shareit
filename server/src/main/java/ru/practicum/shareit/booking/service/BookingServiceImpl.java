...
public class BookingServiceImpl implements BookingService {
    ...
    private void validateCreate(BookingCreateDto dto) {
        if (dto == null) throw new ValidationException("booking must not be null");
        if (dto.getItemId() == null) throw new ValidationException("itemId must not be null");
        if (dto.getStart() == null || dto.getEnd() == null) throw new ValidationException("start/end must not be null");
        LocalDateTime now = LocalDateTime.now();
